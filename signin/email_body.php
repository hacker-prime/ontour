...
<![endif]-->
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:100% !important; width:100%; height:auto !important;" width="700" alt="" data-proportionally-constrained="true" data-responsive="true" src="https://phoenixprime.io/assets/images/phoenix%20logo%20horizontal%20cropped.png">
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 40px 0px 40px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:100% !important; width:100%; height:auto !important;" width="520" alt="" data-proportionally-constrained="true" data-responsive="true" src={email_image}>
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:20px 0px 20px 0px; line-height:24px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 24px"><strong>{email_header}</strong></span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:0px 0px 25px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center">{email_message}</div><div></div></div></td>
      </tr>
    </tbody>
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
              <tbody>
                ...
                <td align="center" bgcolor="#FDBE84" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                  <a href="https://phoenixprime.io/sections/" style="background-color:#FF725E; border:0px solid #333333; border-color:#333333; border-radius:100px; border-width:0px; color:#fff; display:inline-block; font-size:14px; font-weight:bold; letter-spacing:1px; line-height:normal; padding:15px 45px 15px 45px; text-align:center; text-decoration:none; border-style:solid;" target="_blank">CLICK HERE</a>
                </td>
                </tr>
              </tbody>
            </table>
...
<table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button" role="module" style="table-layout:fixed;" width="100%" data-muid="61be82ef-ef72-4bb4-8d38-230d344b6c2c">
    </table></td>
                                      </tr>
                                    </table>
                                    <!--[if mso]>
