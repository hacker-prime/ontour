<form class="form" id="airport_form" method="post" action="">
    ...
    <div class="form-section">
        ...
        <div class="form-row datetime-visible">
            ...
            <div class="datetime-invisible">
                <input type="datetime-local" id="pick-up-date" name="pick-up-date" required>
            </div>
        </div>
        ...
        <div class="form-row">
            <button type="submit" name="airport_form">Submit</button>
        </div>
